    ...
    <section className="w-full px-8 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-base md:text-lg text-muted-foreground my-4 md:my-6">
          Env Lens Studio adalah rumah kreatif di bidang fotografi profesional. Dengan tim fotografer berpengalaman dan peralatan berstandar tinggi, kami menghadirkan hasil visual yang memadukan seni, detail, dan kualitas premium.
        </p>
        <a
          href="/Harga"
          className={cn(
